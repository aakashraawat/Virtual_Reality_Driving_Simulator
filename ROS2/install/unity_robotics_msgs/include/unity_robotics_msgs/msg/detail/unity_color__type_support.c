...
#include <stddef.h>
#include "unity_robotics_msgs/msg/detail/unity_color__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  unity_robotics_msgs__msg__UnityColor__init(message_memory);
}

void UnityColor__rosidl_typesupport_introspection_c__UnityColor_fini_function(void * message_memory)
{
  unity_robotics_msgs__msg__UnityColor__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember UnityColor__rosidl_typesupport_introspection_c__UnityColor_message_member_array[4] = {
  {
    ...
    offsetof(unity_robotics_msgs__msg__UnityColor, r),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(unity_robotics_msgs__msg__UnityColor, g),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(unity_robotics_msgs__msg__UnityColor, b),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(unity_robotics_msgs__msg__UnityColor, a),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers UnityColor__rosidl_typesupport_introspection_c__UnityColor_message_members = {
  ...
  4,  // number of fields
  sizeof(unity_robotics_msgs__msg__UnityColor),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, unity_robotics_msgs, msg, UnityColor)() {
