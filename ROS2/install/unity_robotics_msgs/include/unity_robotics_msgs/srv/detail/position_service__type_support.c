...
#include <stddef.h>
#include "unity_robotics_msgs/srv/detail/position_service__rosidl_typesupport_introspection_c.h"
...
// Member `input`
#include "unity_robotics_msgs/msg/pos_rot.h"
// Member `input`
#include "unity_robotics_msgs/msg/detail/pos_rot__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  unity_robotics_msgs__srv__PositionService_Request__init(message_memory);
}
...
{
  unity_robotics_msgs__srv__PositionService_Request__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember PositionService_Request__rosidl_typesupport_introspection_c__PositionService_Request_message_member_array[1] = {
  {
    ...
    offsetof(unity_robotics_msgs__srv__PositionService_Request, input),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers PositionService_Request__rosidl_typesupport_introspection_c__PositionService_Request_message_members = {
  "unity_robotics_msgs__srv",  // message namespace
  "PositionService_Request",  // message name
  1,  // number of fields
  sizeof(unity_robotics_msgs__srv__PositionService_Request),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, unity_robotics_msgs, srv, PositionService_Request)() {
  PositionService_Request__rosidl_typesupport_introspection_c__PositionService_Request_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, unity_robotics_msgs, msg, PosRot)();
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  unity_robotics_msgs__srv__PositionService_Response__init(message_memory);
}
...
{
  unity_robotics_msgs__srv__PositionService_Response__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember PositionService_Response__rosidl_typesupport_introspection_c__PositionService_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(unity_robotics_msgs__srv__PositionService_Response, output),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers PositionService_Response__rosidl_typesupport_introspection_c__PositionService_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(unity_robotics_msgs__srv__PositionService_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_unity_robotics_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, unity_robotics_msgs, srv, PositionService_Response)() {
...
static rosidl_typesupport_introspection_c__ServiceMembers unity_robotics_msgs__srv__detail__position_service__rosidl_typesupport_introspection_c__PositionService_service_members = {
  "unity_robotics_msgs__srv",  // service namespace
  "PositionService",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // unity_robotics_msgs__srv__detail__position_service__rosidl_typesupport_introspection_c__PositionService_Request_message_type_support_handle,
  NULL  // response message
  // unity_robotics_msgs__srv__detail__position_service__rosidl_typesupport_introspection_c__PositionService_Response_message_type_support_handle
};

static rosidl_service_type_support_t unity_robotics_msgs__srv__detail__position_service__rosidl_typesupport_introspection_c__PositionService_service_type_support_handle = {
  0,
  &unity_robotics_msgs__srv__detail__position_service__rosidl_typesupport_introspection_c__PositionService_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, unity_robotics_msgs, srv, PositionService)() {
  if (!unity_robotics_msgs__srv__detail__position_service__rosidl_typesupport_introspection_c__PositionService_service_type_support_handle.typesupport_identifier) {
    unity_robotics_msgs__srv__detail__position_service__rosidl_typesupport_introspection_c__PositionService_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)unity_robotics_msgs__srv__detail__position_service__rosidl_typesupport_introspection_c__PositionService_service_type_support_handle.data;

  if (!service_members->request_members_) {
    service_members->request_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, unity_robotics_msgs, srv, PositionService_Request)()->data;
  }
  if (!service_members->response_members_) {
    service_members->response_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, unity_robotics_msgs, srv, PositionService_Response)()->data;
  }

  return &unity_robotics_msgs__srv__detail__position_service__rosidl_typesupport_introspection_c__PositionService_service_type_support_handle;
}
