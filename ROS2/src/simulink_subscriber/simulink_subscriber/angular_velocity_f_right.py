...
class AngularVelocityNode(Node):
    ...
    def __init__(self):
        ...
        self.subscription = self.create_subscription(Twist, 'angular_velocity_f_right', self.listener_callback, 10)

        self.publisher_ = self.create_publisher(WheelAngularVelocity, 'angular_velocity_f_right_unity', 10)
...
def main(args=None):
    ...
    angular_velocity_f_right = AngularVelocityNode()
    rclpy.spin(angular_velocity_f_right)
    angular_velocity_f_right.destroy_node()
    rclpy.shutdown()
