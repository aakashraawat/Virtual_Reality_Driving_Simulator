...
#include <stddef.h>
#include "unity_robotics_msgs/srv/detail/object_pose_service__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  unity_robotics_msgs__srv__ObjectPoseService_Request__init(message_memory);
}
...
{
  unity_robotics_msgs__srv__ObjectPoseService_Request__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember ObjectPoseService_Request__rosidl_typesupport_introspection_c__ObjectPoseService_Request_message_member_array[1] = {
  {
    ...
    offsetof(unity_robotics_msgs__srv__ObjectPoseService_Request, object_name),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers ObjectPoseService_Request__rosidl_typesupport_introspection_c__ObjectPoseService_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(unity_robotics_msgs__srv__ObjectPoseService_Request),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, unity_robotics_msgs, srv, ObjectPoseService_Request)() {
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  unity_robotics_msgs__srv__ObjectPoseService_Response__init(message_memory);
}
...
{
  unity_robotics_msgs__srv__ObjectPoseService_Response__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember ObjectPoseService_Response__rosidl_typesupport_introspection_c__ObjectPoseService_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(unity_robotics_msgs__srv__ObjectPoseService_Response, object_pose),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers ObjectPoseService_Response__rosidl_typesupport_introspection_c__ObjectPoseService_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(unity_robotics_msgs__srv__ObjectPoseService_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_unity_robotics_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, unity_robotics_msgs, srv, ObjectPoseService_Response)() {
...
static rosidl_typesupport_introspection_c__ServiceMembers unity_robotics_msgs__srv__detail__object_pose_service__rosidl_typesupport_introspection_c__ObjectPoseService_service_members = {
  "unity_robotics_msgs__srv",  // service namespace
  "ObjectPoseService",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // unity_robotics_msgs__srv__detail__object_pose_service__rosidl_typesupport_introspection_c__ObjectPoseService_Request_message_type_support_handle,
  NULL  // response message
  // unity_robotics_msgs__srv__detail__object_pose_service__rosidl_typesupport_introspection_c__ObjectPoseService_Response_message_type_support_handle
};

static rosidl_service_type_support_t unity_robotics_msgs__srv__detail__object_pose_service__rosidl_typesupport_introspection_c__ObjectPoseService_service_type_support_handle = {
  0,
  &unity_robotics_msgs__srv__detail__object_pose_service__rosidl_typesupport_introspection_c__ObjectPoseService_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, unity_robotics_msgs, srv, ObjectPoseService)() {
  if (!unity_robotics_msgs__srv__detail__object_pose_service__rosidl_typesupport_introspection_c__ObjectPoseService_service_type_support_handle.typesupport_identifier) {
    unity_robotics_msgs__srv__detail__object_pose_service__rosidl_typesupport_introspection_c__ObjectPoseService_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)unity_robotics_msgs__srv__detail__object_pose_service__rosidl_typesupport_introspection_c__ObjectPoseService_service_type_support_handle.data;

  if (!service_members->request_members_) {
    service_members->request_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, unity_robotics_msgs, srv, ObjectPoseService_Request)()->data;
  }
  if (!service_members->response_members_) {
    service_members->response_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, unity_robotics_msgs, srv, ObjectPoseService_Response)()->data;
  }

  return &unity_robotics_msgs__srv__detail__object_pose_service__rosidl_typesupport_introspection_c__ObjectPoseService_service_type_support_handle;
}
