  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  unity_robotics_msgs__msg__PosRot__init(message_memory);
}

void PosRot__rosidl_typesupport_introspection_c__PosRot_fini_function(void * message_memory)
{
  unity_robotics_msgs__msg__PosRot__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember PosRot__rosidl_typesupport_introspection_c__PosRot_message_member_array[7] = {
  {
    ...
    offsetof(unity_robotics_msgs__msg__PosRot, pos_x),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(unity_robotics_msgs__msg__PosRot, pos_y),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(unity_robotics_msgs__msg__PosRot, pos_z),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(unity_robotics_msgs__msg__PosRot, rot_x),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(unity_robotics_msgs__msg__PosRot, rot_y),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(unity_robotics_msgs__msg__PosRot, rot_z),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(unity_robotics_msgs__msg__PosRot, rot_w),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers PosRot__rosidl_typesupport_introspection_c__PosRot_message_members = {
  ...
  "PosRot",  // message name
  7,  // number of fields
  sizeof(unity_robotics_msgs__msg__PosRot),
