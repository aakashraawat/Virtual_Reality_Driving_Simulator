...
class Metaclass_ObjectPoseService(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'unity_robotics_msgs.srv.ObjectPoseService')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from unity_robotics_msgs.srv import _object_pose_service
...
class ObjectPoseService(metaclass=Metaclass_ObjectPoseService):
    from unity_robotics_msgs.srv._object_pose_service import ObjectPoseService_Request as Request
    from unity_robotics_msgs.srv._object_pose_service import ObjectPoseService_Response as Response
