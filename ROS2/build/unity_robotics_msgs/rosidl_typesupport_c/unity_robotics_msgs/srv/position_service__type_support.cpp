...
static const _PositionService_Request_type_support_symbol_names_t _PositionService_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, unity_robotics_msgs, srv, PositionService_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, unity_robotics_msgs, srv, PositionService_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, unity_robotics_msgs, srv, PositionService_Request)() {
  return &::unity_robotics_msgs::srv::rosidl_typesupport_c::PositionService_Request_message_type_support_handle;
}
...
static const _PositionService_Response_type_support_symbol_names_t _PositionService_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, unity_robotics_msgs, srv, PositionService_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, unity_robotics_msgs, srv, PositionService_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_unity_robotics_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, unity_robotics_msgs, srv, PositionService_Response)() {
  return &::unity_robotics_msgs::srv::rosidl_typesupport_c::PositionService_Response_message_type_support_handle;
}
...
static const _PositionService_type_support_symbol_names_t _PositionService_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, unity_robotics_msgs, srv, PositionService)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, unity_robotics_msgs, srv, PositionService)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, unity_robotics_msgs, srv, PositionService)() {
  return &::unity_robotics_msgs::srv::rosidl_typesupport_c::PositionService_service_type_support_handle;
}
