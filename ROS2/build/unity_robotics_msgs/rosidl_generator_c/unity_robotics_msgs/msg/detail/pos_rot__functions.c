...
unity_robotics_msgs__msg__PosRot__create()
{
  ...
  unity_robotics_msgs__msg__PosRot * msg = (unity_robotics_msgs__msg__PosRot *)allocator.allocate(sizeof(unity_robotics_msgs__msg__PosRot), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(unity_robotics_msgs__msg__PosRot));
  bool success = unity_robotics_msgs__msg__PosRot__init(msg);
  if (!success) {
...
unity_robotics_msgs__msg__PosRot__destroy(unity_robotics_msgs__msg__PosRot * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    unity_robotics_msgs__msg__PosRot__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
unity_robotics_msgs__msg__PosRot__Sequence__init(unity_robotics_msgs__msg__PosRot__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  unity_robotics_msgs__msg__PosRot * data = NULL;

  if (size) {
    data = (unity_robotics_msgs__msg__PosRot *)allocator.zero_allocate(size, sizeof(unity_robotics_msgs__msg__PosRot), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = unity_robotics_msgs__msg__PosRot__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        unity_robotics_msgs__msg__PosRot__fini(&data[i - 1]);
      }
...
unity_robotics_msgs__msg__PosRot__Sequence__fini(unity_robotics_msgs__msg__PosRot__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      unity_robotics_msgs__msg__PosRot__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  unity_robotics_msgs__msg__PosRot__Sequence * array = (unity_robotics_msgs__msg__PosRot__Sequence *)allocator.allocate(sizeof(unity_robotics_msgs__msg__PosRot__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = unity_robotics_msgs__msg__PosRot__Sequence__init(array, size);
  if (!success) {
...
unity_robotics_msgs__msg__PosRot__Sequence__destroy(unity_robotics_msgs__msg__PosRot__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    unity_robotics_msgs__msg__PosRot__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
unity_robotics_msgs__msg__PosRot__Sequence__are_equal(const unity_robotics_msgs__msg__PosRot__Sequence * lhs, const unity_robotics_msgs__msg__PosRot__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!unity_robotics_msgs__msg__PosRot__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  unity_robotics_msgs__msg__PosRot__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(unity_robotics_msgs__msg__PosRot);
    unity_robotics_msgs__msg__PosRot * data =
      (unity_robotics_msgs__msg__PosRot *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!unity_robotics_msgs__msg__PosRot__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          unity_robotics_msgs__msg__PosRot__fini(&data[i]);
        }
        free(data);
        return false;
      }
