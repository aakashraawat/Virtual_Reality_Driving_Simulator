...
#include "unity_robotics_msgs/msg/detail/unity_color__rosidl_typesupport_fastrtps_c.h"
...
using _UnityColor__ros_msg_type = unity_robotics_msgs__msg__UnityColor;
...
size_t get_serialized_size_unity_robotics_msgs__msg__UnityColor(
  const void * untyped_ros_message,
...
static uint32_t _UnityColor__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_unity_robotics_msgs__msg__UnityColor(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_unity_robotics_msgs
size_t max_serialized_size_unity_robotics_msgs__msg__UnityColor(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_unity_robotics_msgs__msg__UnityColor(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, unity_robotics_msgs, msg, UnityColor)() {
