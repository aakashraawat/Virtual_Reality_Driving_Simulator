...
#include "unity_robotics_msgs/srv/detail/position_service__rosidl_typesupport_fastrtps_c.h"
...
#include "unity_robotics_msgs/msg/detail/pos_rot__functions.h"  // input

// forward declare type support functions
size_t get_serialized_size_unity_robotics_msgs__msg__PosRot(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_unity_robotics_msgs__msg__PosRot(
  bool & full_bounded,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, unity_robotics_msgs, msg, PosRot)();


using _PositionService_Request__ros_msg_type = unity_robotics_msgs__srv__PositionService_Request;
  ...
  // Field name: input
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, unity_robotics_msgs, msg, PosRot
      )()->data);
...
size_t get_serialized_size_unity_robotics_msgs__srv__PositionService_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PositionService_Request__ros_msg_type * ros_message = static_cast<const _PositionService_Request__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_unity_robotics_msgs__msg__PosRot(
...
static uint32_t _PositionService_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_unity_robotics_msgs__srv__PositionService_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_unity_robotics_msgs
size_t max_serialized_size_unity_robotics_msgs__srv__PositionService_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
  ...
  // member: input
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_unity_robotics_msgs__msg__PosRot(
...
{
  return max_serialized_size_unity_robotics_msgs__srv__PositionService_Request(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_PositionService_Request = {
  "unity_robotics_msgs::srv",
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, unity_robotics_msgs, srv, PositionService_Request)() {
...
// already included above
// #include "unity_robotics_msgs/msg/detail/pos_rot__functions.h"  // output
...
using _PositionService_Response__ros_msg_type = unity_robotics_msgs__srv__PositionService_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_unity_robotics_msgs
size_t get_serialized_size_unity_robotics_msgs__srv__PositionService_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PositionService_Response__ros_msg_type * ros_message = static_cast<const _PositionService_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_unity_robotics_msgs__srv__PositionService_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_unity_robotics_msgs
size_t max_serialized_size_unity_robotics_msgs__srv__PositionService_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_unity_robotics_msgs__srv__PositionService_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, unity_robotics_msgs, srv, PositionService_Response)() {
...
// already included above
// #include "unity_robotics_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "unity_robotics_msgs/srv/position_service.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, unity_robotics_msgs, srv, PositionService)() {
