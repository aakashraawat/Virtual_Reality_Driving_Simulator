...
#include "unity_robotics_msgs/srv/detail/object_pose_service__rosidl_typesupport_fastrtps_c.h"
...
using _ObjectPoseService_Request__ros_msg_type = unity_robotics_msgs__srv__ObjectPoseService_Request;
...
size_t get_serialized_size_unity_robotics_msgs__srv__ObjectPoseService_Request(
  const void * untyped_ros_message,
...
static uint32_t _ObjectPoseService_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_unity_robotics_msgs__srv__ObjectPoseService_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_unity_robotics_msgs
size_t max_serialized_size_unity_robotics_msgs__srv__ObjectPoseService_Request(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_unity_robotics_msgs__srv__ObjectPoseService_Request(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, unity_robotics_msgs, srv, ObjectPoseService_Request)() {
...
// forward declare type support functions
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_unity_robotics_msgs
...
using _ObjectPoseService_Response__ros_msg_type = unity_robotics_msgs__srv__ObjectPoseService_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_unity_robotics_msgs
size_t get_serialized_size_unity_robotics_msgs__srv__ObjectPoseService_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ObjectPoseService_Response__ros_msg_type * ros_message = static_cast<const _ObjectPoseService_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_unity_robotics_msgs__srv__ObjectPoseService_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_unity_robotics_msgs
size_t max_serialized_size_unity_robotics_msgs__srv__ObjectPoseService_Response(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_unity_robotics_msgs__srv__ObjectPoseService_Response(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, unity_robotics_msgs, srv, ObjectPoseService_Response)() {
...
// already included above
// #include "unity_robotics_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "unity_robotics_msgs/srv/object_pose_service.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, unity_robotics_msgs, srv, ObjectPoseService)() {
