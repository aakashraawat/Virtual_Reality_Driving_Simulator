...
#include "unity_robotics_msgs/msg/detail/pos_rot__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const unity_robotics_msgs::msg::PosRot *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<unity_robotics_msgs::msg::PosRot *>(
    untyped_ros_message);
...
{
  return &unity_robotics_msgs::msg::typesupport_fastrtps_cpp::_PosRot__handle;
}
