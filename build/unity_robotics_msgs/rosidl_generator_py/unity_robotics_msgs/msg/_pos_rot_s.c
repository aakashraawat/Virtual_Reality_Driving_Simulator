...
bool unity_robotics_msgs__msg__pos_rot__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("unity_robotics_msgs.msg._pos_rot.PosRot", full_classname_dest, 39) == 0);
  }
  unity_robotics_msgs__msg__PosRot * ros_message = _ros_message;
  {  // pos_x
...
PyObject * unity_robotics_msgs__msg__pos_rot__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("unity_robotics_msgs.msg._pos_rot");
