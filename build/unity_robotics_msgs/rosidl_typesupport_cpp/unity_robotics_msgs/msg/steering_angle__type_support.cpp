...
static const _SteeringAngle_type_support_symbol_names_t _SteeringAngle_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, unity_robotics_msgs, msg, SteeringAngle)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, unity_robotics_msgs, msg, SteeringAngle)),
  }
};
...
{
  return &::unity_robotics_msgs::msg::rosidl_typesupport_cpp::SteeringAngle_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, unity_robotics_msgs, msg, SteeringAngle)() {
  return get_message_type_support_handle<unity_robotics_msgs::msg::SteeringAngle>();
}
