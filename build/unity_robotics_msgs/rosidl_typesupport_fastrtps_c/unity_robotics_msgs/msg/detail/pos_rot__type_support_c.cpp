...
#include "unity_robotics_msgs/msg/detail/pos_rot__rosidl_typesupport_fastrtps_c.h"
...
using _PosRot__ros_msg_type = unity_robotics_msgs__msg__PosRot;
...
static uint32_t _PosRot__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_unity_robotics_msgs__msg__PosRot(
...
{
  return max_serialized_size_unity_robotics_msgs__msg__PosRot(
    full_bounded, 0);
}
