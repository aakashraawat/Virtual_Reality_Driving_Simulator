...
public class AngularVelocityWheelRRight : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        ROSConnection.GetOrCreateInstance().Subscribe<RosAngularVelocity>("angular_velocity_r_right_unity", OnReceiveWheelVelocity);
    }
